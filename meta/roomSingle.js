export default (componentContext) => {
  ...
  twitter : [
    ...
    {hid: 'twitter:image:src', name:'twitter:image:src', content: componentContext.sourceFolder + componentContext.room.profileImage},
  ],
  ...
  facebook : [
    ...
    {hid: 'og:image', name:'og:image', content: componentContext.sourceFolder + componentContext.room.profileImage},
  ]
}
